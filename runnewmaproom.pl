...
system("rdfcache -ruleset='$ruleset' -cache=newmaproomcache file://$maproomtoolsdir/ingridregistry.owl file://$pwd/maproomregistry.owl >>newmaproomcache/rdfcachelog.txt");
...
EOQ
close IP;
system("rdfcache -ruleset='$ruleset' -cache=newmaproomcache -construct=maproom_section_index.serql -constructoutput=./tabs.nt file://$maproomtoolsdir/ingridregistry.owl file://$pwd/maproomregistry.owl >>newmaproomcache/rdfcachelog.txt");
